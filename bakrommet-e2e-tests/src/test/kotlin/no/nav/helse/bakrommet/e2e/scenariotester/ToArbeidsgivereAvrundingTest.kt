    ...
    fun `to arbeidsgivere med lav og høy inntekt gir avrundingsgevinst`() {
        Scenario(
            listOf(
                Arbeidstaker(
                    "911111111",
                    inntekt = SkjønnsfastsattManglendeRapportering(120000.0),
                    dagoversikt = SykAlleDager(),
                ),
                Arbeidstaker(
                    "922222222",
                    inntekt = SkjønnsfastsattManglendeRapportering(624168.0),
                    dagoversikt = SykAlleDager(),
                ),
            ),
        ).run {
    ...
    fun `én arbeidsgiver med full 6G får lavere utbetaling pga avrundingstap`() {
        Scenario(
            listOf(
                Arbeidstaker(
                    "911111111",
                    inntekt = SkjønnsfastsattManglendeRapportering(744168.0),
                    dagoversikt = SykAlleDager(),
                ),
            ),
        ).run {
