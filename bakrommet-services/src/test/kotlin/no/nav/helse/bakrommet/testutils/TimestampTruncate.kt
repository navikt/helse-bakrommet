...
fun BehandlingDbRecord.truncateTidspunkt() = copy(opprettet = opprettet.truncatedTo(SECONDS))

@JvmName("tidsstuttetSaksbehandlingsperiode")
fun Iterable<BehandlingDbRecord>.tidsstuttet() = map(BehandlingDbRecord::truncateTidspunkt)
