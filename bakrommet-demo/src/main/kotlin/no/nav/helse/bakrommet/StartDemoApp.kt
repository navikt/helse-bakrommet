...
class FakeDaoer : AlleDaoer {
    ...
    override val sykefraværstilfelleVersjonRepository =
        object : SykefraværstilfelleVersjonRepository {
            private val sykefraværstilfeller = ConcurrentHashMap<SykefraværstilfelleVersjonId, SykefraværstilfelleVersjon>()

            override fun lagre(sykefraværstilfelleVersjon: SykefraværstilfelleVersjon) {
                sykefraværstilfeller[sykefraværstilfelleVersjon.id] = sykefraværstilfelleVersjon
            }

            override fun finn(sykefraværstilfelleVersjonId: SykefraværstilfelleVersjonId): SykefraværstilfelleVersjon? = sykefraværstilfeller[sykefraværstilfelleVersjonId]
        }
